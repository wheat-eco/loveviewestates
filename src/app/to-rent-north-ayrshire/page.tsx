...
async function getNorthAyrshireRentals() {
  ...
  // Fetch rental properties in North Ayrshire
  ...
  if (error) {
    console.error("Error fetching North Ayrshire rentals:", error)
    return []
  }

  console.log(`Found ${properties?.length || 0} rental properties in North Ayrshire`)
  return properties || []
}
