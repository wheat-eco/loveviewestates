...
export const metadata = {
  ...
  description: "Browse our selection of properties for sale in East Ayrshire.",
}
...
export default async function ForSaleEastAyrshirePage() {
  const properties = await getEastAyrshireProperties()

  return (
    <section className={styles.rentalSection}>
      <div className={styles.rentalContainer}>
        <h1 className={styles.rentalHeading}>FOR SALE EAST AYRSHIRE</h1>
        ...
        <div className={styles.propertiesList}>
          {properties.length > 0 ? (
            ...
            <div className={styles.noProperties}>
              <p>
                No properties currently for sale in East Ayrshire. Please check back soon or contact us for more
                information.
              </p>
            </div>
          )}
